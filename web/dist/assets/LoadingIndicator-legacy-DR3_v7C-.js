System.register(["./preact-app-legacy-PB7hD_5g.js"],(function(e,t){"use strict";var r;return{setters:[e=>{r=e.h}],execute:function(){function t({message:e="Loading...",size:t="md",fullPage:a=!1}){const s={sm:"w-6 h-6",md:"w-10 h-10",lg:"w-16 h-16"},d=s[t]||s.md;return a?r`
  ...
  `}e({C:function({isLoading:e,hasData:a,children:s,loadingMessage:d="Loading data...",emptyMessage:i="No data available"}){return e?r`<${t} message=${d} />`:a?s:r`
    ...
    `},L:t})}}}));
//# sourceMappingURL=LoadingIndicator-legacy-DR3_v7C-.js.map

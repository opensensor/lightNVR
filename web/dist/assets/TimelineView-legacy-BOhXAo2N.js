System.register(["./preact-app-legacy-BFI6DEaf.js","./LoadingIndicator-legacy-cf6-sIe4.js"],(function(e,t){"use strict";var n,o,r,s,i,a,l;return{setters:[e=>{n=e.d,o=e.y,r=e.h,s=e.c,i=e.A,a=e.E},e=>{l=e.L}],execute:function(){function t(){const[e,t]=n(!1),[i,a]=n(1);o((()=>{console.log("TimelineControls: Setting up subscription to timelineState");const e=p.subscribe((e=>{console.log("TimelineControls: Received state update:",e),console.log("TimelineControls: Is playing:",e.isPlaying),console.log("TimelineControls: Zoom level:",e.zoomLevel),console.log("TimelineControls: Segments count:",e.timelineSegments?.length||0),t(e.isPlaying),a(e.zoomLevel)}));return console.log("TimelineControls: Initial timelineState:",p),()=>e()}),[]);const l=()=>{p.setState({isPlaying:!1});const e=document.querySelector("#video-player video");e&&e.pause()},c=()=>{if(!p.timelineSegments||0===p.timelineSegments.length)return void s("No recordings to play","warning");let e=0,t=Number.MAX_SAFE_INTEGER;p.timelineSegments.forEach(((n,o)=>{n.start_timestamp<t&&(t=n.start_timestamp,e=o)})),console.log(`Starting from earliest segment (index ${e})`),p.setState({currentSegmentIndex:e,currentTime:p.timelineSegments[e].start_timestamp,isPlaying:!0,forceReload:!0});const n=p.timelineSegments[e],o=document.querySelector("#video-player video");o&&(console.log("Loading earliest segment video:",n),o.pause(),o.removeAttribute("src"),o.load(),o.src=`/api/recordings/play/${n.id}?t=${Date.now()}`,o.onloadedmetadata=()=>{o.currentTime=0,o.play().catch((e=>{console.error("Error playing video:",e),s("Error playing video: "+e.message,"error")}))})};return r`
    <div class="timeline-controls flex justify-between items-center mb-2">
      ...
      <div class="flex items-center gap-1">
        ...
        <button 
          ...
          onClick=${()=>{if(i>1){const e=i/2;p.setState({zoomLevel:e}),s(`Zoomed out: ${24/e} hours view`,"info")}}}
        ...
        <button 
          id="zoom-in-button" 
          class="w-6 h-6 rounded bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 flex items-center justify-center focus:outline-none focus:ring-1 focus:ring-blue-500 transition-colors"
          onClick=${()=>{if(i<8){const e=2*i;p.setState({zoomLevel:e}),s(`Zoomed in: ${24/e} hours view`,"info")}}}
  ...
  `}function c(){const[e,t]=n(0),[s,i]=n(24),[a,l]=n(1);return o((()=>{console.log("TimelineRuler: Setting up subscription to timelineState");const e=p.subscribe((e=>{console.log("TimelineRuler: Received state update:",e),console.log("TimelineRuler: Zoom level:",e.zoomLevel);const n=24/e.zoomLevel;console.log("TimelineRuler: Hours per view:",n);let o=12;if(null!==e.currentTime){const t=new Date(1e3*e.currentTime);o=t.getHours()+t.getMinutes()/60+t.getSeconds()/3600}else if(e.timelineSegments&&e.timelineSegments.length>0){let t=24,n=0;e.timelineSegments.forEach((e=>{const o=new Date(1e3*e.start_timestamp),r=new Date(1e3*e.end_timestamp),s=o.getHours()+o.getMinutes()/60+o.getSeconds()/3600,i=r.getHours()+r.getMinutes()/60+r.getSeconds()/3600;t=Math.min(t,s),n=Math.max(n,i)})),o=(t+n)/2}let r=Math.max(0,o-n/2),s=Math.min(24,r+n);24===s&&n<24?(r=Math.max(0,24-n),s=24):0===r&&n<24&&(s=Math.min(24,n)),console.log("TimelineRuler: New hour range:",{newStartHour:r,newEndHour:s}),t(r),i(s),l(e.zoomLevel),p.timelineStartHour===r&&p.timelineEndHour===s||p.setState({timelineStartHour:r,timelineEndHour:s})}));return()=>e()}),[]),r`
  ...
  `}function d(){const[e,t]=n(0),[s,a]=n(!1),[l,c]=n(0),[m,d]=n(24),[g,u]=n(null),[h,v]=n(!1),f=i(null);i(null);const b=i(0);o((()=>{const e=p.subscribe((e=>{c(e.timelineStartHour||0),d(e.timelineEndHour||24),u(e.currentTime),S(e.currentTime),h||y(e.currentTime,e.timelineStartHour||0,e.timelineEndHour||24)}));return()=>e()}),[h]),o((()=>{const e=f.current;if(!e)return;const n=e=>{e.preventDefault(),e.stopPropagation(),b.current=e.clientX,v(!0),document.addEventListener("mousemove",o),document.addEventListener("mouseup",r)},o=n=>{if(!h)return;const o=e.parentElement;if(!o)return;const r=o.getBoundingClientRect(),s=Math.max(0,Math.min(n.clientX-r.left,r.width))/r.width*100;t(s);const i=l+s/100*(m-l),a=new Date(p.selectedDate);a.setHours(Math.floor(i)),a.setMinutes(Math.floor(i%1*60)),a.setSeconds(Math.floor(i%1*60%1*60));const c=a.getTime()/1e3;S(c)},r=t=>{if(!h)return;const n=e.parentElement;if(!n)return;const s=n.getBoundingClientRect(),i=Math.max(0,Math.min(t.clientX-s.left,s.width)),a=s.width,c=l+i/a*100/100*(m-l),d=new Date(p.selectedDate);d.setHours(Math.floor(c)),d.setMinutes(Math.floor(c%1*60)),d.setSeconds(Math.floor(c%1*60%1*60));const g=d.getTime()/1e3;v(!1),document.removeEventListener("mousemove",o),document.removeEventListener("mouseup",r);const u=p.timelineSegments||[];let f=!1;for(let e=0;e<u.length;e++){const t=u[e],n=t.local_start_timestamp||t.start_timestamp,o=t.local_end_timestamp||t.end_timestamp;if(g>=n&&g<=o){p.setState({currentSegmentIndex:e,currentTime:g,prevCurrentTime:p.currentTime,isPlaying:!0}),f=!0;break}}if(!f&&u.length>0){let e=0,t=1/0;for(let r=0;r<u.length;r++){const n=u[r],o=n.local_start_timestamp||n.start_timestamp,s=n.local_end_timestamp||n.end_timestamp,i=Math.abs(o-g),a=Math.abs(s-g),l=Math.min(i,a);l<t&&(t=l,e=r)}const n=u[e],o=n.local_start_timestamp||n.start_timestamp;p.setState({currentSegmentIndex:e,currentTime:o,prevCurrentTime:p.currentTime,isPlaying:!0})}};return e.addEventListener("mousedown",n),()=>{e.removeEventListener("mousedown",n),document.removeEventListener("mousemove",o),document.removeEventListener("mouseup",r)}}),[f.current,l,m,h]);const y=(e,n,o)=>{if(null===e)return void a(!1);const r=new Date(1e3*e),s=r.getHours()+r.getMinutes()/60+r.getSeconds()/3600;s<n||s>o?a(!1):(t((s-n)/(o-n)*100),a(!0))},S=e=>{if(null===e)return;const t=document.getElementById("time-display");if(!t)return;const n=new Date(1e3*e),o=n.getHours().toString().padStart(2,"0"),r=n.getMinutes().toString().padStart(2,"0"),s=n.getSeconds().toString().padStart(2,"0");t.textContent=`${o}:${r}:${s}`};return o((()=>{setTimeout((()=>{p.currentTime&&(a(!0),y(p.currentTime,p.timelineStartHour||0,p.timelineEndHour||24))}),500)}),[]),r`
    <div 
      ref=${f}
  ...
  `}function u(){const[e,t]=n(-1),[a,l]=n(!1),[c,m]=n([]),[d,u]=n(1),h=i(null),v=i(null),f=i(null);o((()=>{const e=p.subscribe((e=>{t(e.currentSegmentIndex),l(e.isPlaying),m(e.timelineSegments||[]),u(e.playbackSpeed),b(e)}));return()=>e()}),[]);const b=e=>{const t=h.current;if(!t)return;if(!e.timelineSegments||0===e.timelineSegments.length||e.currentSegmentIndex<0||e.currentSegmentIndex>=e.timelineSegments.length)return;const n=e.timelineSegments[e.currentSegmentIndex];if(!n)return;const o=f.current!==n.id,r=o,s=n.local_start_timestamp||n.start_timestamp,i=null!==e.currentTime&&e.currentTime>=s?e.currentTime-s:0,a=null!==e.prevCurrentTime&&Math.abs(e.currentTime-e.prevCurrentTime)>1;o&&(console.log(`Segment changed from ${f.current} to ${n.id}`),f.current=n.id),r?(console.log(`Loading new segment ${n.id} (segmentChanged: ${o})`),y(n,i,e.isPlaying)):a?(console.log(`Seeking to ${i}s within current segment`),t.currentTime=i):e.isPlaying&&t.paused?t.play().catch((e=>{console.error("Error playing video:",e)})):e.isPlaying||t.paused||t.pause(),t.playbackRate!==e.playbackSpeed&&(t.playbackRate=e.playbackSpeed)},y=(e,t=0,n=!1)=>{const o=h.current;if(!o)return;console.log(`Loading segment ${e.id} at time ${t}s, autoplay: ${n}`),o.pause();const r=`/api/recordings/play/${e.id}?t=${Date.now()}`,i=()=>{console.log("Video metadata loaded"),o.currentTime=t,o.playbackRate=d,n&&o.play().catch((e=>{console.error("Error playing video:",e),s("Error playing video: "+e.message,"error")})),o.removeEventListener("loadedmetadata",i)};o.addEventListener("loadedmetadata",i),o.src=r,o.load()},S=e=>{if(null===e)return;const t=document.getElementById("time-display");if(!t)return;const n=new Date(1e3*e),o=n.getHours().toString().padStart(2,"0"),r=n.getMinutes().toString().padStart(2,"0"),s=n.getSeconds().toString().padStart(2,"0");t.textContent=`${o}:${r}:${s}`};return r`
    <div class="timeline-player-container mb-2" id="video-player">
      <div class="relative w-full bg-black rounded-lg shadow-md" style="aspect-ratio: 16/9;">
        <video
            ...
            muted=${!1}
            playsInline
            onended=${()=>{if(console.log("Video ended"),e<c.length-1){const t=e+1;console.log(`Playing next segment ${t}`);const n=c[t],o=n.local_start_timestamp||n.start_timestamp;p.setState({currentSegmentIndex:t,currentTime:o,isPlaying:!0,forceReload:!0})}else console.log("End of all segments"),p.setState({isPlaying:!1})}}
            ontimeupdate=${()=>{const t=h.current;if(!t)return;if(e<0||!c||0===c.length||e>=c.length)return;const n=c[e];if(!n)return;const o=(n.local_start_timestamp||n.start_timestamp)+t.currentTime;S(o),p.setState({currentTime:o,prevCurrentTime:v.current}),v.current=o}}
        ></video>
    ...
    <${g} />
  `}e("loadTimelineView",(function(){const e=document.getElementById("main-content");e&&(e.innerHTML="",a(r`<${h} />`,e))}));const p={streams:[],timelineSegments:[],selectedStream:null,selectedDate:null,isPlaying:!1,currentSegmentIndex:-1,zoomLevel:1,timelineStartHour:0,timelineEndHour:24,currentTime:null,prevCurrentTime:null,playbackSpeed:1,showOnlySegments:!0,forceReload:!1,listeners:new Set,setState(e){Object.assign(this,e),this.notifyListeners()},subscribe(e){return this.listeners.add(e),()=>this.listeners.delete(e)},notifyListeners(){this.listeners.forEach((e=>e(this)))}};function h(){const e=function(){const e=new URLSearchParams(window.location.search);return{stream:e.get("stream")||"",date:e.get("date")||(t=new Date,`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,"0")}-${String(t.getDate()).padStart(2,"0")}`)};var t}(),[a,g]=n(!1),[h,v]=n([]),[f,b]=n(e.stream),[y,S]=n(e.date),[x,w]=n([]),$=i(null),k=i(!1);o((()=>{console.log("TimelinePage: Initial mount, loading streams"),T()}),[]),o((()=>{if(h.length>0&&!k.current)if(console.log("TimelinePage: Streams loaded, initializing data"),k.current=!0,h.some((e=>e.name===f))&&f)console.log(`TimelinePage: Using stream from URL: ${f}`),_(f,y);else if(h.length>0){const e=h[0].name;console.log(`TimelinePage: Using first stream: ${e}`),b(e),_(e,y)}}),[h]);const T=()=>{console.log("TimelinePage: Loading streams"),g(!0),fetch("/api/streams").then((e=>{if(!e.ok)throw new Error("Failed to load streams");return e.json()})).then((e=>{console.log("TimelinePage: Streams data received:",e);const t=Array.isArray(e)?e:[];console.log(`TimelinePage: Loaded ${t.length} streams`),v(t),g(!1),p.setState({streams:t}),t.length>0&&console.log("TimelinePage: First stream:",t[0])})).catch((e=>{console.error("TimelinePage: Error loading streams:",e),s("Error loading streams: "+e.message,"error"),g(!1)}))},_=(e,t)=>{if(!e)return void s("Please select a stream","error");console.log(`TimelinePage: Loading timeline data for ${e} on ${t}`),g(!0),w([]),s("Loading timeline data...","info"),function(e,t){if(!e)return;const n=new URL(window.location.href);n.searchParams.set("stream",e),n.searchParams.set("date",t),window.history.replaceState({},"",n)}(e,t);const n=new Date(t);n.setHours(0,0,0,0);const o=new Date(t);o.setHours(23,59,59,999);const r=n.toISOString(),i=o.toISOString();p.setState({selectedStream:e,selectedDate:t,timelineSegments:[],currentSegmentIndex:-1,currentTime:null,isPlaying:!1}),fetch(`/api/timeline/segments?stream=${encodeURIComponent(e)}&start=${encodeURIComponent(r)}&end=${encodeURIComponent(i)}`).then((e=>{if(!e.ok)throw new Error("Failed to load timeline data");return e.json()})).then((e=>{console.log("TimelinePage: Timeline data received:",e);const t=e.segments||[];if(console.log(`TimelinePage: Received ${t.length} segments`),g(!1),0===t.length)return console.log("TimelinePage: No segments found"),w([]),p.setState({timelineSegments:[],currentSegmentIndex:-1,currentTime:null,isPlaying:!1}),void s("No recordings found for the selected date","warning");console.log("TimelinePage: Setting segments"),w(t);const n=t[0].start_timestamp;p.setState({timelineSegments:t,currentSegmentIndex:0,currentTime:n,prevCurrentTime:n,isPlaying:!1});const o=document.querySelector("#video-player video");o&&(o.src=`/api/recordings/play/${t[0].id}`,o.load()),s(`Loaded ${t.length} recording segments`,"success")})).catch((e=>{console.error("TimelinePage: Error loading timeline data:",e),s("Error loading timeline data: "+e.message,"error"),g(!1),w([])}))};return r`
      ...
      <div class="flex flex-wrap gap-4 mb-2">
        <div class="stream-selector flex-grow">
          ...
          <select
              ...
              value=${f||""}
              onChange=${e=>{const t=e.target.value;console.log(`TimelinePage: Stream changed to ${t}`),b(t),t&&_(t,y)}}
          >
        ...
        <div class="date-selector flex-grow">
          ...
          <input
              ...
              class="w-full p-2 border rounded dark:bg-gray-700 dark:border-gray-600 dark:text-white"
              value=${y}
              onChange=${e=>{const t=e.target.value;console.log(`TimelinePage: Date changed to ${t}`),S(t),f&&_(f,t)}}
          />
        </div>
      </div>
  ...
  `}}}}));
//# sourceMappingURL=TimelineView-legacy-BOhXAo2N.js.map

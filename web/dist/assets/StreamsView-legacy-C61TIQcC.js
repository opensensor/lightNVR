System.register(["./preact-app-legacy-DSJ0xsf-.js","./LoadingIndicator-legacy-BdRRzioS.js"],(function(e,t){"use strict";var r,a,s,o,d,n,i,l,c;return{setters:[e=>{r=e.d,a=e.h,s=e.k,o=e.u,d=e.j,n=e._,i=e.c,l=e.f},e=>{c=e.C}],execute:function(){function u({streamId:e,streamName:t,onClose:s,onDisable:o,onDelete:d}){const[n,i]=r(!1);return a`
  ...
  `}function m(){const e=s(),[t,n]=r(!1),[m,g]=r(!1),[p,b]=r(!1),[y,f]=r(!1),[h,x]=r([]),[v,w]=r([]),[k,$]=r(null),[C,S]=r(null),[E,_]=r(""),[D,I]=r({username:"",password:""}),[T,P]=r(!1),[A,j]=r(!1),{data:O=[],isLoading:M,error:N}=o(["streams"],"/api/streams",{timeout:1e4,retries:2,retryDelay:1e3}),{data:F}=o(["detectionModels"],"/api/detection/models",{timeout:5e3,retries:1,retryDelay:1e3}),B=Array.isArray(O)?O:O.streams||[];console.log("API Response:",O),console.log("Streams data:",B),console.log("hasData:",B&&B.length>0);const[R,V]=r({name:"",url:"",enabled:!0,streamingEnabled:!0,width:1280,height:720,fps:15,codec:"h264",protocol:"0",priority:"5",segment:30,record:!0,recordAudio:!0,detectionEnabled:!1,detectionModel:"",detectionThreshold:50,detectionInterval:10,preBuffer:10,postBuffer:30}),[U,q]=r(!1),[z,L]=r(!1),[H,Q]=r(null),K=B&&B.length>0,J=F?.models||[],X=d({mutationFn:async e=>await l("/api/streams",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),timeout:15e3,retries:1,retryDelay:1e3}),onSuccess:()=>{i("Stream added successfully"),te(),e.invalidateQueries({queryKey:["streams"]})},onError:e=>{i(`Error adding stream: ${e.message}`,5e3,"error")}}),W=d({mutationFn:async e=>await l(`/api/streams/${encodeURIComponent(e.name)}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),timeout:15e3,retries:1,retryDelay:1e3}),onSuccess:()=>{i("Stream updated successfully"),te(),e.invalidateQueries({queryKey:["streams"]})},onError:e=>{i(`Error updating stream: ${e.message}`,5e3,"error")}}),Y=(e,t)=>{U?W.mutate(e,t):X.mutate(e,t)},G=d({mutationFn:async e=>(i("Testing stream connection..."),await l("/api/streams/test",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:e.url,protocol:parseInt(e.protocol,10)}),timeout:2e4,retries:1,retryDelay:2e3})),onSuccess:e=>{e.success?i("Stream connection successful!",3e3,"success"):i(`Stream connection failed: ${e.message}`,5e3,"error")},onError:e=>{i(`Error testing stream: ${e.message}`,5e3,"error")}}),Z=d({mutationFn:async e=>await l(`/api/streams/${encodeURIComponent(e)}`,{method:"DELETE",timeout:1e4,retries:1,retryDelay:1e3}),onSuccess:()=>{i("Stream deleted successfully"),ee(),e.invalidateQueries({queryKey:["streams"]})},onError:e=>{i(`Error deleting stream: ${e.message}`,5e3,"error")}});d({mutationFn:async({streamId:e,enabled:t})=>await l(`/api/streams/${encodeURIComponent(e)}/enable`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({enabled:!t}),timeout:1e4,retries:1,retryDelay:1e3}),onSuccess:(t,r)=>{i(`Stream ${r.enabled?"disabled":"enabled"} successfully`),e.invalidateQueries({queryKey:["streams"]})},onError:e=>{i(`Error toggling stream state: ${e.message}`,5e3,"error")}});const ee=()=>{L(!1),Q(null)},te=()=>{n(!1)},re=e=>{const{name:t,value:r,type:a,checked:s}=e.target;V((e=>({...e,[t]:"checkbox"===a?s:r})))},ae=e=>{const{name:t,value:r}=e.target;I((e=>({...e,[t]:r})))},se=d({mutationFn:async()=>(P(!0),await l("/api/onvif/discovery/discover",{method:"POST",timeout:12e4,retries:0,body:JSON.stringify({})})),onSuccess:e=>{x(e.devices||[]),P(!1)},onError:e=>{i(`Error discovering ONVIF devices: ${e.message}`,5e3,"error"),P(!1)}}),oe=d({mutationFn:async({device:e,credentials:t})=>(j(!0),await l("/api/onvif/device/profiles",{method:"GET",headers:{"X-Device-URL":`http://${e.ip_address}/onvif/device_service`,"X-Username":t.username,"X-Password":t.password},timeout:2e4,retries:0})),onSuccess:e=>{w(e.profiles||[]),j(!1)},onError:e=>{i(`Error loading device profiles: ${e.message}`,5e3,"error"),j(!1)}}),de=d({mutationFn:async e=>(j(!0),await l("/api/onvif/device/test",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:`http://${e.ip_address}/onvif/device_service`,username:D.username,password:D.password}),timeout:15e3,retries:0})),onSuccess:(e,t)=>{e.success?(i("Connection successful!",3e3,"success"),ie(t)):(i(`Connection failed: ${e.message}`,5e3,"error"),j(!1))},onError:e=>{i(`Error testing connection: ${e.message}`,5e3,"error"),j(!1)}}),ne=d({mutationFn:async e=>await l(`/api/streams/${encodeURIComponent(e)}/disable`,{method:"POST",timeout:1e4,retries:1,retryDelay:1e3}),onSuccess:()=>{i("Stream disabled successfully"),ee(),e.invalidateQueries({queryKey:["streams"]})},onError:e=>{i(`Error disabling stream: ${e.message}`,5e3,"error")}}),ie=e=>{$(e),w([]),oe.mutate({device:e,credentials:D})};return a`
    <section id="streams-page" class="page">
      <div class="page-header flex justify-between items-center mb-4 p-4 bg-white dark:bg-gray-800 rounded-lg shadow">
        ...
        <div class="controls flex space-x-2">
          ...
          <button
              ...
              onClick=${()=>{V({name:"",url:"",enabled:!0,streamingEnabled:!0,width:1280,height:720,fps:15,codec:"h264",protocol:"0",priority:"5",segment:30,record:!0,recordAudio:!0,detectionEnabled:!1,detectionModel:"",detectionThreshold:50,detectionInterval:10,preBuffer:10,postBuffer:30}),q(!1),n(!0)}}
          >
            Add Stream
          </button>
        </div>
                  ...
                  <td class="px-6 py-4 whitespace-nowrap">
                    <div class="flex space-x-2">
                      <button
                          ...
                          onClick=${()=>(async t=>{try{const r=await e.fetchQuery({queryKey:["stream",t],queryFn:async()=>{const e=await fetch(`/api/streams/${encodeURIComponent(t)}`);if(!e.ok)throw new Error(`HTTP error ${e.status}`);return e.json()},staleTime:1e4});V({...r,width:r.width||1280,height:r.height||720,fps:r.fps||15,protocol:r.protocol?.toString()||"0",priority:r.priority?.toString()||"5",segment:r.segment_duration||30,detectionThreshold:r.detection_threshold||50,detectionInterval:r.detection_interval||10,preBuffer:r.pre_detection_buffer||10,postBuffer:r.post_detection_buffer||30,streamingEnabled:void 0===r.streaming_enabled||r.streaming_enabled,isOnvif:void 0!==r.is_onvif&&r.is_onvif,detectionEnabled:r.detection_based_recording||!1,detectionModel:r.detection_model||"",recordAudio:void 0===r.record_audio||r.record_audio}),q(!0),n(!0)}catch(N){console.error("Error loading stream details:",N),i("Error loading stream details: "+N.message)}})(t.name)}
                          title="Edit"
                      >
      ...
      ${z&&H&&a`
        <${u}
            ...
            streamName=${H.name}
            onClose=${ee}
            onDisable=${e=>{ne.mutate(e)}}
            onDelete=${e=>{Z.mutate(e)}}
        />
      `}
                    ...
                    <tr key=${e.ip_address} class="hover:bg-gray-50 dark:hover:bg-gray-700">
                      ...
                      <td class="px-6 py-4 whitespace-nowrap">
                        <button
                            ...
                            disabled=${A&&k&&k.ip_address===e.ip_address}
                            type="button"
                        >
                          ${A&&k&&k.ip_address===e.ip_address?a`
                            <span class="flex items-center">
                                Loading
                                <span class="ml-1 flex space-x-1">
                                  <span class="animate-pulse delay-0 h-1.5 w-1.5 bg-white rounded-full"></span>
  ...
  `}e({StreamsView:m,loadStreamsView:function(){const e=document.getElementById("main-content");e&&n((async()=>{const{render:e}=await t.import("./preact-app-legacy-DSJ0xsf-.js").then((e=>e.p));return{render:e}}),void 0,t.meta.url).then((({render:r})=>{n((async()=>{const{QueryClientProvider:e,queryClient:r}=await t.import("./preact-app-legacy-DSJ0xsf-.js").then((e=>e.m));return{QueryClientProvider:e,queryClient:r}}),void 0,t.meta.url).then((({QueryClientProvider:t,queryClient:s})=>{r(a`<${t} client=${s}><${m} /></${t}>`,e)}))}))}})}}}));
//# sourceMappingURL=StreamsView-legacy-C61TIQcC.js.map

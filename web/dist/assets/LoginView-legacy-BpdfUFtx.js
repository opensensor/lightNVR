System.register(["./preact-app-legacy-CipbyXzH.js"],(function(e,t){"use strict";var r,o,a,s;return{setters:[e=>{r=e.d,o=e.A,a=e.h,s=e._}],execute:function(){function n(){const[e,t]=r(""),[s,n]=r(""),[i,d]=r(!1),[l,u]=r("");r((()=>{const e=new URLSearchParams(window.location.search);e.has("error")?u("Invalid username or password"):e.has("auth_required")&&e.has("logout")?u("You have been successfully logged out."):e.has("auth_required")?u("Authentication required. Please log in to continue."):e.has("logout")&&u("You have been successfully logged out.")})),o(null);const c=()=>{const e=new URLSearchParams(window.location.search).get("redirect");window.location.href=e||"/index.html?t="+(new Date).getTime()};return a`
  ...
  `}e({LoginView:n,loadLoginView:function(){const e=document.getElementById("main-content");e&&s((async()=>{const{render:e}=await t.import("./preact-app-legacy-CipbyXzH.js").then((e=>e.p));return{render:e}}),void 0,t.meta.url).then((({render:t})=>{t(a`<${n} />`,e)}))}})}}}));
//# sourceMappingURL=LoginView-legacy-BpdfUFtx.js.map

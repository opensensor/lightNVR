System.register(["./preact-app-legacy-DM_ugUM5.js","./LoadingIndicator-legacy-ReWXZ_-H.js"],(function(e,t){"use strict";var a,r,s,d,i,o,n,l,g;return{setters:[e=>{a=e.d,r=e.u,s=e.i,d=e.y,i=e.h,o=e._,n=e.s,l=e.j},e=>{g=e.C}],execute:function(){function c(){const[e,t]=a({logLevel:"2",storagePath:"/var/lib/lightnvr/recordings",storagePathHls:"",maxStorage:"0",retention:"30",autoDelete:!0,dbPath:"/var/lib/lightnvr/lightnvr.db",webPort:"8080",authEnabled:!0,username:"admin",password:"admin",webrtcDisabled:!1,bufferSize:"1024",useSwap:!0,swapSize:"128",detectionModelsPath:"",defaultDetectionThreshold:50,defaultPreBuffer:5,defaultPostBuffer:10}),{data:o,isLoading:c,error:b,refetch:u}=r(["settings"],"/api/settings",{timeout:15e3,retries:2,retryDelay:1e3}),p=s({mutationKey:["saveSettings"],mutationFn:async e=>await l("/api/settings",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),timeout:2e4,retries:1,retryDelay:2e3}),onSuccess:()=>{n("Settings saved successfully"),u()},onError:e=>{console.error("Error saving settings:",e),n(`Error saving settings: ${e.message}`)}});d((()=>{if(o){console.log("Settings loaded:",o);const e={logLevel:o.log_level?.toString()||"",storagePath:o.storage_path||"",storagePathHls:o.storage_path_hls||"",maxStorage:o.max_storage_size?.toString()||"",retention:o.retention_days?.toString()||"",autoDelete:o.auto_delete_oldest||!1,dbPath:o.db_path||"",webPort:o.web_port?.toString()||"",authEnabled:o.web_auth_enabled||!1,username:o.web_username||"",password:o.web_password||"",webrtcDisabled:o.webrtc_disabled||!1,bufferSize:o.buffer_size?.toString()||"",useSwap:o.use_swap||!1,swapSize:o.swap_size?.toString()||"",detectionModelsPath:o.models_path||"",defaultDetectionThreshold:o.default_detection_threshold||50,defaultPreBuffer:o.pre_detection_buffer?.toString()||"5",defaultPostBuffer:o.post_detection_buffer?.toString()||"10"};t((t=>({...t,...e})))}}),[o]);const m=e=>{const{name:a,value:r,type:s,checked:d}=e.target;t((e=>({...e,[a]:"checkbox"===s?d:r})))};return i`
  ...
  `}e({SettingsView:c,loadSettingsView:function(){const e=document.getElementById("main-content");e&&o((async()=>{const{render:e}=await t.import("./preact-app-legacy-DM_ugUM5.js").then((e=>e.p));return{render:e}}),void 0,t.meta.url).then((({render:a})=>{o((async()=>{const{QueryClientProvider:e,queryClient:a}=await t.import("./preact-app-legacy-DM_ugUM5.js").then((e=>e.n));return{QueryClientProvider:e,queryClient:a}}),void 0,t.meta.url).then((({QueryClientProvider:t,queryClient:r})=>{a(i`<${t} client=${r}><${c} /></${t}>`,e)}))}))}})}}}));
//# sourceMappingURL=SettingsView-legacy-BHqkKGuq.js.map

System.register(["./preact-app-legacy-BGf75F8U.js","./LoadingIndicator-legacy-ZjxIB90R.js"],(function(e,t){"use strict";var r,a,s,o,d,n,i,l,c;return{setters:[e=>{r=e.d,a=e.h,s=e.f,o=e.u,d=e.m,n=e._,i=e.c,l=e.j},e=>{c=e.C}],execute:function(){function u({streamId:e,streamName:t,onClose:s,onDisable:o,onDelete:d}){const[n,i]=r(!1);return a`
  ...
  `}e({StreamsView:m,loadStreamsView:function(){const e=document.getElementById("main-content");e&&n((async()=>{const{render:e}=await t.import("./preact-app-legacy-BGf75F8U.js").then((e=>e.p));return{render:e}}),void 0,t.meta.url).then((({render:r})=>{n((async()=>{const{QueryClientProvider:e,queryClient:r}=await t.import("./preact-app-legacy-BGf75F8U.js").then((e=>e.o));return{QueryClientProvider:e,queryClient:r}}),void 0,t.meta.url).then((({QueryClientProvider:t,queryClient:s})=>{r(a`<${t} client=${s}><${m} /></${t}>`,e)}))}))}})}}}));
//# sourceMappingURL=StreamsView-legacy-BPbm1MGe.js.map

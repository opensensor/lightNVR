System.register(["./preact-app-legacy-CxO7jMLm.js","./LoadingIndicator-legacy-DkS6_Ola.js","./fetch-utils-legacy-DOz1-Xee.js"],(function(e,t){"use strict";var r,a,s,o,n,d,i,l,c,u;return{setters:[e=>{r=e.d,a=e.h,s=e.A,o=e.y,n=e._,d=e.c},e=>{i=e.C},e=>{l=e.f,c=e.e,u=e.c}],execute:function(){function g({streamId:e,streamName:t,onClose:s,onDisable:o,onDelete:n}){const[d,i]=r(!1);return a`
  ...
  `}e({StreamsView:p,loadStreamsView:function(){const e=document.getElementById("main-content");e&&n((async()=>{const{render:e}=await t.import("./preact-app-legacy-CxO7jMLm.js").then((e=>e.p));return{render:e}}),void 0,t.meta.url).then((({render:t})=>{t(a`<${p} />`,e)}))}})}}}));
//# sourceMappingURL=StreamsView-legacy-zLILnHGS.js.map

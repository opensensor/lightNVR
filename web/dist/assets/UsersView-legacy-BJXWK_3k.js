System.register(["./preact-app-legacy-Bx1EbLQP.js"],(function(e,t){"use strict";var r,a,o,s,n,l,d,i,c;return{setters:[e=>{r=e.h,a=e.d,o=e.m,s=e.u,n=e.y,l=e.i,d=e.s,i=e._,c=e.j}],execute:function(){e({UsersView:m,loadUsersView:function(){const e=document.getElementById("users-container");e&&i((async()=>{const{render:e}=await t.import("./preact-app-legacy-Bx1EbLQP.js").then((e=>e.p));return{render:e}}),void 0,t.meta.url).then((({render:a})=>{i((async()=>{const{QueryClientProvider:e,queryClient:r}=await t.import("./preact-app-legacy-Bx1EbLQP.js").then((e=>e.n));return{QueryClientProvider:e,queryClient:r}}),void 0,t.meta.url).then((({QueryClientProvider:t,queryClient:o})=>{a(r`<${t} client=${o}><${m} /></${t}>`,e)}))}))}});const u={0:"Admin",1:"User",2:"Viewer",3:"API"};function b({users:e,onEdit:t,onDelete:a,onApiKey:o}){return r`
  ...
  `:r`
      ...
      />`}
    `}}}}));
//# sourceMappingURL=UsersView-legacy-BJXWK_3k.js.map

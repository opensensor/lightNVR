System.register(["./preact-app-legacy-CilCHnTM.js","./fetch-utils-legacy-DOz1-Xee.js"],(function(e,t){"use strict";var r,a,s,o,n,l,d,i,c,u;return{setters:[e=>{r=e.h,a=e.d,s=e.A,o=e.q,n=e.y,l=e._,d=e.c},e=>{i=e.c,c=e.f,u=e.e}],execute:function(){e({UsersView:v,loadUsersView:function(){const e=document.getElementById("users-container");e&&l((async()=>{const{render:e}=await t.import("./preact-app-legacy-CilCHnTM.js").then((e=>e.p));return{render:e}}),void 0,t.meta.url).then((({render:t})=>{t(r`<${v} />`,e)}))}});const b={0:"Admin",1:"User",2:"Viewer",3:"API"};function p({users:e,onEdit:t,onDelete:a,onApiKey:s}){return r`
  ...
  `:r`
      ...
      />`}
    `}}}}));
//# sourceMappingURL=UsersView-legacy-Dlz59VY1.js.map

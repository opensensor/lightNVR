System.register(["./preact-app-legacy-BfZz7QfI.js"],(function(e,t){"use strict";var r,a,o,s,n,l,d,i,c;return{setters:[e=>{r=e.h,a=e.d,o=e.n,s=e.u,n=e.y,l=e.m,d=e.c,i=e._,c=e.j}],execute:function(){e({UsersView:m,loadUsersView:function(){const e=document.getElementById("users-container");e&&i((async()=>{const{render:e}=await t.import("./preact-app-legacy-BfZz7QfI.js").then((e=>e.p));return{render:e}}),void 0,t.meta.url).then((({render:a})=>{i((async()=>{const{QueryClientProvider:e,queryClient:r}=await t.import("./preact-app-legacy-BfZz7QfI.js").then((e=>e.o));return{QueryClientProvider:e,queryClient:r}}),void 0,t.meta.url).then((({QueryClientProvider:t,queryClient:o})=>{a(r`<${t} client=${o}><${m} /></${t}>`,e)}))}))}});const u={0:"Admin",1:"User",2:"Viewer",3:"API"};function b({users:e,onEdit:t,onDelete:a,onApiKey:o}){return r`
  ...
  `:r`
      ...
      />`}
    `}}}}));
//# sourceMappingURL=UsersView-legacy-DXNxc8oK.js.map

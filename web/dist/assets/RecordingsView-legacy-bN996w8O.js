System.register(["./preact-app-legacy-XZUKaCaj.js","./LoadingIndicator-legacy-hqIGWaUk.js","./fetch-utils-legacy-DOz1-Xee.js"],(function(e,t){"use strict";var r,a,o,n,s,i,d,l,c,g,p;return{setters:[e=>{r=e.h,a=e.c,o=e.d,n=e.A,s=e.y,i=e.D,d=e._,l=e.f},e=>{c=e.C},e=>{g=e.f,p=e.e}],execute:function(){function u({filters:e,setFilters:t,pagination:a,setPagination:o,streams:n,filtersVisible:s,applyFilters:i,resetFilters:d,handleDateRangeChange:l,setDefaultDateRange:c}){return r`
    ...
    <section id="recordings-page" class="page">
      ...
      <div class="recordings-layout flex flex-col md:flex-row gap-4 w-full">
        ...
        <div class="recordings-content flex-1">
          <${m}
            activeFiltersDisplay=${C}
            removeFilter=${e=>{switch(e){case"dateRange":S((e=>({...e,dateRange:"last7days"})));break;case"streamId":S((e=>({...e,streamId:"all"})));break;case"recordingType":S((e=>({...e,recordingType:"all"})))}Q()}}
            hasActiveFilters=${P}
          />
          ...
          >
            <${y}
              ...
              sortField=${v}
              sortDirection=${$}
              sortBy=${e=>{v===e?k("asc"===$?"desc":"asc"):(k("start_time"===e?"desc":"asc"),x(e)),G()}}
              ...
              playRecording=${e=>{f.playRecording(e,l)}}
              downloadRecording=${e=>{f.downloadRecording(e)}}
              deleteRecording=${async e=>{if(!confirm(`Are you sure you want to delete this recording from ${e.stream}?`))return;const t=new URLSearchParams(window.location.search),r=t.get("sort")||v,a=t.get("order")||$,o=parseInt(t.get("page"),10)||R.currentPage;await f.deleteRecording(e)&&ee(r,a,o)}}
            ...
            <${b}
              pagination=${R}
              goToPage=${e=>{if(e<1||e>R.totalPages)return;T((t=>({...t,currentPage:e})));const t={...R,currentPage:e};w.updateUrlWithFilters(D,t,v,$),setTimeout((()=>{G(e,!1)}),0)}}
            />
          <//>
        </div>
      </div>
      ...
      <${i}
        isOpen=${_}
        onClose=${Z}
        onConfirm=${async()=>{Z();const e=new URLSearchParams(window.location.search),t=e.get("sort")||v,r=e.get("order")||$,a=parseInt(e.get("page"),10)||R.currentPage;if("selected"===O){const e=await f.deleteSelectedRecordings(E);z({}),B(!1),e.succeeded>0&&ee(t,r,a)}else{const e=await f.deleteAllFilteredRecordings(D);z({}),B(!1),e.succeeded>0&&G()}}}
        mode=${O}
        count=${X()}
      />
    </section>
  `}}}}));
//# sourceMappingURL=RecordingsView-legacy-bN996w8O.js.map

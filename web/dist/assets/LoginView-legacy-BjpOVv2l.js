System.register(["./preact-app-legacy-DSJ0xsf-.js"],(function(e,t){"use strict";var r,o,a,n,s,i;return{setters:[e=>{r=e.d,o=e.A,a=e.h,n=e._,s=e.l,i=e.g}],execute:function(){function d(){const[e,t]=r(""),[n,d]=r(""),[l,u]=r(!1),[c,g]=r("");r((()=>{const e=new URLSearchParams(window.location.search);e.has("error")?g("Invalid username or password"):e.has("auth_required")&&g("Authentication required. Please log in to continue.")}));const m=o(null);return a`
  ...
  `}e({LoginView:d,loadLoginView:function(){const e=document.getElementById("main-content");e&&n((async()=>{const{render:e}=await t.import("./preact-app-legacy-DSJ0xsf-.js").then((e=>e.p));return{render:e}}),void 0,t.meta.url).then((({render:t})=>{t(a`<${d} />`,e)}))}})}}}));
//# sourceMappingURL=LoginView-legacy-BjpOVv2l.js.map

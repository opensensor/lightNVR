System.register(["./preact-app-legacy-BhpL4WKm.js","./LoadingIndicator-legacy-BSj327NC.js","./fetch-utils-legacy-DOz1-Xee.js"],(function(e,s){"use strict";var t,o,n,l,r,a,i,d,g,c;return{setters:[e=>{t=e.h,o=e.d,n=e.A,l=e.y,r=e._,a=e.c},e=>{i=e.C},e=>{d=e.f,g=e.e,c=e.c}],execute:function(){function u({restartSystem:e,shutdownSystem:s,isRestarting:o,isShuttingDown:n}){return t`
  ...
  `}function y({systemInfo:e,formatBytes:s}){return t`
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
      ...
      <div class="space-y-4">
        <div>
          <div class="flex justify-between mb-1">
            ...
            <span>${e.memory?.used?s(e.memory.used):"0"} / ${e.memory?.total?s(e.memory.total):"0"}</span>
          </div>
          <div class="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
            <div class="bg-blue-600 h-2.5 rounded-full" style=${`width: ${e.memory?.total?(e.memory.used/e.memory.total*100).toFixed(1):0}%`}></div>
          </div>
        </div>
        <div>
          <div class="flex justify-between mb-1">
    ...
    <section id="system-page" class="page">
      ...
      >
        ...
        <${b} 
          ...
          logLevel=${x} 
          logCount=${L} 
          setLogLevel=${e=>{console.log(`SystemView: Setting log level from ${x} to ${e}`),console.log("Current stack trace:",(new Error).stack),S(e),C.current=e,console.log(`SystemView: logLevelRef is now: ${C.current}`),setTimeout((()=>{console.log(`SystemView: After setState, logLevel is now: ${x}`),console.log(`SystemView: After setState, logLevelRef is now: ${C.current}`)}),0)}} 
          setLogCount=${I} 
          loadLogs=${P} 
          clearLogs=${async()=>{if(confirm("Are you sure you want to clear all logs?"))try{a("Clearing logs..."),await g("/api/system/logs/clear",{method:"POST",signal:W.current?.signal,timeout:15e3,retries:1,retryDelay:1e3}),a("Logs cleared successfully"),P()}catch(e){console.error("Error clearing logs:",e),a("Error clearing logs: "+e.message)}}} 
        />
  ...
  `}e({SystemView:k,loadSystemView:function(){const e=document.getElementById("main-content");e&&r((async()=>{const{render:e}=await s.import("./preact-app-legacy-BhpL4WKm.js").then((e=>e.p));return{render:e}}),void 0,s.meta.url).then((({render:s})=>{s(t`<${k} />`,e),setTimeout((()=>{const e=new CustomEvent("refresh-system-info");window.dispatchEvent(e)}),100)}))}}),window.addEventListener("load",(()=>{window.addEventListener("refresh-system-info",(async()=>{try{(await g("/api/system/info",{timeout:15e3,retries:1,retryDelay:1e3})).ok&&console.log("System info refreshed")}catch(e){console.error("Error refreshing system info:",e)}}))}))}}}));
//# sourceMappingURL=SystemView-legacy-W11D3rie.js.map

...
async function saveStream() {
    ...
    try {
        ...
        // Then show success message using the toast system after data is refreshed
        console.log('Attempting to show success toast after data refresh');
        if (typeof showSuccessToast === 'function') {
            console.log('Using showSuccessToast function');
            showSuccessToast('Stream saved successfully', 5000);
        } else {
            console.log('Falling back to showStatusMessage');

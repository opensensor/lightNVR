 ...
 * @param {Function} props.onSuccess - Function called after successful user edit
 * @returns {JSX.Element} Edit user modal
 */
export function EditUserModal({ currentUser, formData, handleInputChange, handleEditUser, onClose, onSuccess }) {
  // Add this function to prevent event propagation and handle success callback
  const handleSubmit = (e) => {
    e.preventDefault();
    e.stopPropagation(); // Stop event from bubbling up
    handleEditUser(e).then(() => {
      if (onSuccess) {
